...
public class LevelManager {
	...
	public void generateLevelFromFile(float dt) {
		...
		if (powerupTime >= Constants.POWERUP_TIME) {
			
			int i = generator.nextInt(Powerup.PowerupType.values().length);
			
			Powerup powerup = PowerupSpawner.createPowerup(Powerup.PowerupType.values()[i]);
	...
	*/
	...
	public void generateRandomLevel(float dt) {
		...
		if (enemyTime > Constants.ENEMY_RATE) {
